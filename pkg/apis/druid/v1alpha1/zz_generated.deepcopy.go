...
func (in *DruidClusterSpec) DeepCopyInto(out *DruidClusterSpec) {
	*out = *in
	if in.TemplateValuesRefs != nil {
		in, out := &in.TemplateValuesRefs, &out.TemplateValuesRefs
		*out = make([]TemplateValuesRef, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateValuesRef) DeepCopyInto(out *TemplateValuesRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateValuesRef.
func (in *TemplateValuesRef) DeepCopy() *TemplateValuesRef {
	if in == nil {
		return nil
	}
	out := new(TemplateValuesRef)
	in.DeepCopyInto(out)
	return out
}
